    ...
    <>
      ...
      <Modal show={isShow}>
        <Modal.Header closeButton onClick={initModal}>
          <Modal.Title><span className='chut'>Select crypto on which you want to trade</span></Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <fieldset>
        ...
        <Modal.Footer>
          <Button className="closedd" variant="danger" onClick={initModal}>
            Close
          </Button>
          <Button className="closedd" variant="dark" onClick={submite}>
            Ok
          </Button>
        </Modal.Footer>
      </Modal>
